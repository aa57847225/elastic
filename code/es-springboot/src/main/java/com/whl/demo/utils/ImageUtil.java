...
//        }
    ...
    public static void createImage(List<String> files, String outPath) throws Exception{
        ...
        BufferedImage ImageNew = new BufferedImage(132,132,BufferedImage.TYPE_INT_RGB);//设置背景为白色
        for(int m=0;m<132;m++){
            for(int n=0;n<132;n++){
        ...
        for(int i=0;i<imageSize.length;i++){
            ...
            String f = zoom(files.get(i),"/opt/img/temp",width,width);
    ...
    public static void main(String[] args) throws Exception{
        ...
        imgList.add("http://erp-cfpu-com.oss-cn-hangzhou.aliyuncs.com/6d92de90f34a4f458c4a3343a1072427.jpg");
        imgList.add("http://erp-cfpu-com.oss-cn-hangzhou.aliyuncs.com/c60a24d714cf4479a60541ea6958bddd.JPG");
        imgList.add("http://erp-cfpu-com.oss-cn-hangzhou.aliyuncs.com/6d92de90f34a4f458c4a3343a1072427.jpg");
        imgList.add("http://erp-cfpu-com.oss-cn-hangzhou.aliyuncs.com/c60a24d714cf4479a60541ea6958bddd.JPG");
        imgList.add("http://erp-cfpu-com.oss-cn-hangzhou.aliyuncs.com/6d92de90f34a4f458c4a3343a1072427.jpg");
        imgList.add("http://erp-cfpu-com.oss-cn-hangzhou.aliyuncs.com/c60a24d714cf4479a60541ea6958bddd.JPG");
        ...
        createImage(imgList,"d://group//g.png");
